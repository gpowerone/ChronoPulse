...
import GeneratedPricingPageView from '../../views/pricing_page';
...
export const metadata: Metadata = { title: "Pricing Plans", description: "Pricing page showing subscription tiers and plans" };
