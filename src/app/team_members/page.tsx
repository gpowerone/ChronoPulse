...
import GeneratedTeamMembersDashboardLinkView from '../../views/team_members_dashboard_link';
import GeneratedUserDashboardMenuView from '../../views/user_dashboard_menu';
import GeneratedProjectMembersView from '../../views/project_members';
...
export const metadata: Metadata = { title: "Team Members", description: "Component for managing project team members" };
      ...
      <main>
                    ...
                    <div className="h-full grid grid-cols-12 relative">
                        <div className="h-full w-full col-span-12 md:col-span-12 lg:col-span-12" style={{ backgroundColor: 'transparent', paddingLeft: '25px', paddingTop: '12px', paddingBottom: '8px', marginTop: '8px', marginBottom: '8px' }}>
                            <GeneratedTeamMembersDashboardLinkView isContainer={false} />
                        </div>
                    </div>
