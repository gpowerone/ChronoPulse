...
import GeneratedProjectWorkspaceDashboardLinkView from '../../views/project_workspace_dashboard_link';
import GeneratedUserDashboardMenuView from '../../views/user_dashboard_menu';
import GeneratedProjectBoardView from '../../views/project_board';
...
export const metadata: Metadata = { title: "Project Workspace", description: "Project detail view with kanban task board" };
      ...
      <main>
                    ...
                    <div className="h-full grid grid-cols-12 relative">
                        <div className="h-full w-full col-span-12 md:col-span-12 lg:col-span-12" style={{ backgroundColor: 'transparent', paddingLeft: '25px', paddingTop: '12px', paddingBottom: '8px', marginTop: '8px', marginBottom: '8px' }}>
                            <GeneratedProjectWorkspaceDashboardLinkView isContainer={false} />
                        </div>
                    </div>
