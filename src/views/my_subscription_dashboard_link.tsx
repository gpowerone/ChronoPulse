...
interface GeneratedMySubscriptionDashboardLinkViewProps {
  isContainer?: boolean;
}

export default function GeneratedMySubscriptionDashboardLinkView({ isContainer = false }: GeneratedMySubscriptionDashboardLinkViewProps){
  return (
