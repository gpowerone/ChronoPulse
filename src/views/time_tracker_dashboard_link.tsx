...
interface GeneratedTimeTrackerDashboardLinkViewProps {
  isContainer?: boolean;
}

export default function GeneratedTimeTrackerDashboardLinkView({ isContainer = false }: GeneratedTimeTrackerDashboardLinkViewProps){
  return (
