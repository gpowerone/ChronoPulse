...
interface GeneratedProjectWorkspaceDashboardLinkViewProps {
  isContainer?: boolean;
}

export default function GeneratedProjectWorkspaceDashboardLinkView({ isContainer = false }: GeneratedProjectWorkspaceDashboardLinkViewProps){
  return (
