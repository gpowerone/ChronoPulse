...
interface GeneratedMyProjectsDashboardLinkViewProps {
  isContainer?: boolean;
}

export default function GeneratedMyProjectsDashboardLinkView({ isContainer = false }: GeneratedMyProjectsDashboardLinkViewProps){
  return (
