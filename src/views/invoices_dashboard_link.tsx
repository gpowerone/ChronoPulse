...
interface GeneratedInvoicesDashboardLinkViewProps {
  isContainer?: boolean;
}

export default function GeneratedInvoicesDashboardLinkView({ isContainer = false }: GeneratedInvoicesDashboardLinkViewProps){
  return (
