...
interface GeneratedTaskBoardDashboardLinkViewProps {
  isContainer?: boolean;
}

export default function GeneratedTaskBoardDashboardLinkView({ isContainer = false }: GeneratedTaskBoardDashboardLinkViewProps){
  return (
